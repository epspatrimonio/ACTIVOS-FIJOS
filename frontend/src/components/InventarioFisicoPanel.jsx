    ...
    <div className="flex-1 flex flex-col min-h-0 space-y-4 animate-fadeIn w-full max-w-full overflow-hidden">
      ...
      <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between shrink-0 mb-1">
        <div className="module-heading">
          <p className="module-kicker">Conciliación patrimonial</p>
          ...
          <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
            Registro y conciliación de Faltantes (no hallados) y Sobrantes (bienes encontrados sin registro).
          </p>
        </div>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between bg-white/50 backdrop-blur-sm p-3 rounded-2xl border border-slate-200/60 shrink-0">
        ...
        <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 bg-[#00b074] hover:bg-[#009b66] text-white font-extrabold py-2 px-4 rounded-2xl text-xs shadow-sm active:scale-[0.98] transition-all cursor-pointer border-none h-[2.25rem] shrink-0"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 bg-[#ff3b5c] hover:bg-[#e02e4d] text-white font-extrabold py-2 px-4 rounded-2xl text-xs shadow-sm active:scale-[0.98] transition-all cursor-pointer border-none h-[2.25rem] shrink-0"
          >
