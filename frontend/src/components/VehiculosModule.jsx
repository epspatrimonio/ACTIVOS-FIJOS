  ...
  useEffect(() => {
    ...
    if (item) {
      ...
      setForm({
        ...
        cuenta_contable: item.cuenta_contable ?? (isControl ? '3391010101' : '3341110000'),
        centro_costo: item.centro_costo ?? '10101001',
      ...
      setForm({
        ...
        cod_patrimonial: '',
        cuenta_contable: '3341110000',
        centro_costo: '10101001',
        cod_categoria: 40001,
        denominacion: '',
        marca: '',
        modelo: '',
  ...
  const handleSave = async () => {
    ...
    try {
      const assetPayload = {
        ...
        cuenta_contable: form.cuenta_contable || item?.cuenta_contable || (form.tipo_registro === 'CONTROL_SUJETO' || form.cod_patrimonial?.startsWith('339') ? '3391010101' : '3341110000'),
        centro_costo: form.centro_costo || item?.centro_costo || '10101001',
