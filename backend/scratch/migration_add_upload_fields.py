...
async def main():
    ...
    async with engine.begin() as conn:
        print("Agregando columnas de subida a la tabla af.fct_registro_activos...")
        await conn.execute(text("ALTER TABLE af.fct_registro_activos ADD COLUMN IF NOT EXISTS pdf_expediente_path VARCHAR(350);"))
        await conn.execute(text("ALTER TABLE af.fct_registro_activos ADD COLUMN IF NOT EXISTS imagen_1_path VARCHAR(350);"))
        await conn.execute(text("ALTER TABLE af.fct_registro_activos ADD COLUMN IF NOT EXISTS imagen_2_path VARCHAR(350);"))
        await conn.execute(text("ALTER TABLE af.fct_registro_activos ADD COLUMN IF NOT EXISTS imagen_3_path VARCHAR(350);"))
        ...
        await conn.execute(text("""
            ...
            SELECT
                ...
                -- Nuevas columnas de adjuntos/imágenes
